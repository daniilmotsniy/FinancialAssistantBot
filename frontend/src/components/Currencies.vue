<template>
    <div>
        <h3>Here we have list of your currencies</h3>
        <br>
        <table id="data">
            <tr>
                <th>Currencie</th>
            ...
            <tr>
                <td>Add new</td>
                <td><input v-model="ticker" placeholder="type currencie ticker here"></td>
                <td><a id="add" v-on:click="$emit('add-currencies', ticker)">Add</a></td>
            </tr>
        </table>
        <br>
    </div>
